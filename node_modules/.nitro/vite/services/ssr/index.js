...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-C9h2nQTt.js");
...
var manifest = {
	"2427678765f4050b4906070696222be51fd7faabc994016ba620294fdba72d73": {
		...
		importer: () => import("./assets/book-server-CGGK_k8Y.js")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./assets/router-CdA9Lyn8.js").then((n) => n.t),
