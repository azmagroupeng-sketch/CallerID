...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C9h2nQTt.mjs");
...
var manifest = {
	"2427678765f4050b4906070696222be51fd7faabc994016ba620294fdba72d73": {
		functionName: "deleteCall_createServerFn_handler",
		importer: () => import("./book-server-CGGK_k8Y.mjs")
	},
	"5ce76cd6cbf7b1faf30c65fe56da6851e8678f32e7e7951eb06fb0cdec6ecf19": {
		functionName: "createContact_createServerFn_handler",
		importer: () => import("./book-server-CGGK_k8Y.mjs")
	},
	"6bc6fb99b6c512ba8054d12bdd06f36d51b2977a0f3280935bd7ee5f085c93b8": {
		functionName: "deleteContact_createServerFn_handler",
		importer: () => import("./book-server-CGGK_k8Y.mjs")
	},
	"834220eb244bb7f121a467dbf07b506e4c8436789c4e23de7e61f871b4153475": {
		functionName: "patchContact_createServerFn_handler",
		importer: () => import("./book-server-CGGK_k8Y.mjs")
	},
	"94d37bcb62a992fb2b7cd627b13ae85a778b703f0a4218b9078b6cd88b8fa717": {
		functionName: "listBook_createServerFn_handler",
		importer: () => import("./book-server-CGGK_k8Y.mjs")
	},
	"fe6fa65ce93a510e4b38403dd877efbc73956eb65a3c381a2feaf4ce7e706f85": {
		functionName: "createCall_createServerFn_handler",
		importer: () => import("./book-server-CGGK_k8Y.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CdA9Lyn8.mjs").then((n) => n.t),
